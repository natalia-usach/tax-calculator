import { getGrossAnnualSalary, getAnnualTaxPaid, getGrossMonthlySalary, getMonthlyTaxPaid, getNetAnnualSalary, getNetMonthlySalary } from "../helpers/tax-calculator";
